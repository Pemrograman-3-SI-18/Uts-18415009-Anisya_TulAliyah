  ...
  data () {
    return {
      ...
      columns: [
        ...
        { name: 'JumblahBeliBarang', align: 'center', label: 'Jumblah Beli Barang', field: 'jumblahbelibarang' },
      ...
      data: [
        ...
        },
        {
          ...
          namapembeli: 'Raisya khoirunnisa',
          JenisMebel: 'Dipan kasur',
          hargamebel: '50000000',
          jumblahbelibarang: '2',
          total: '100000000'
