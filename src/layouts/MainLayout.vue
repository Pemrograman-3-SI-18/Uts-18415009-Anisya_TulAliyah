            ...
            <div class="row no-wrap q-pa-lg">
              <div class="column">
                ...
                <div class="items-center">
                  <div class="text-bold items-center">18415009</div>
              ...
              <div class="column items-center">
                <q-btn flat round dense>
                  <q-avatar size="72px">
                    <img src="statics/anisajaya.jpg"  alt="statics/anisajaya.jpg">
                  </q-avatar>
                </q-btn>
        ...
        <q-list>
          ...
          <q-item class="justify-center text-center q-mb-md q-pt-md">
            <div>
              ...
              <div class="text-weight-bold">___ PT ANNISA ___</div>
              <div>SIAP MELAYANI PELANGGAN</div>
              <div></div>
            </div>
          </q-item>
          <q-item-label
          ...
          <q-item clickable active-class="active" exact v-ripple to="/admin/inputdatamebel">
            <q-item-section avatar>
              <q-icon name="input" />
            </q-item-section>
            <q-item-section>
          ...
          <q-item clickable active-class="active" exact v-ripple to="/admin/stokmebel">
            <q-item-section avatar>
              <q-icon name="search" />
            </q-item-section>
            <q-item-section>
